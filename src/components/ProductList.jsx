    ...
    <div className="bg-transparent lg:pb-10">
      ...
      >
        <div
          style={{
            clipPath:
              "polygon(0% 100%, 6% 81%, 22% 70%, 36% 73%, 23% 80%, 28% 87%, 48% 83%, 42% 91%, 51% 97%, 47% 100%, 59% 87%, 35% 96%, 63% 77%, 59% 70%, 70% 82%, 48% 73%)",
          }}
          className="relative left-[calc(30%+0rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:right-[calc(50%+36rem)] sm:w-[72.1875rem]"
        />
      </div>
    </div>
  );
